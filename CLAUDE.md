...
Telegram bot for summarizing forwarded messages. Users forward a batch of messages, choose processing level (min/mid/max), summarization style (original/summary/instruction/blog), output format (markdown/tlg/pdf/docx), and whether to save media. The bot summarizes via OpenAI API and returns the result with optional file attachments.
...
- **Exporter**: converts summary to markdown/tlg/pdf/docx, attaches media
