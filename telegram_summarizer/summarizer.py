...
STYLE_PROMPTS = {
    ...
    "blog": (
        ...
        "Use a natural, readable short narrative style with smooth transitions. "
    ...
    "summary": (
        ...
        "presenting it as a brief, structured summary. Output as a single cohesive document. Keep people names."
    ),
}
